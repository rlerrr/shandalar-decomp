...
typedef enum
{
	...
	// 2-color hybrid
	HYBRID_WU = (COLOR_TEST_WHITE | COLOR_TEST_BLUE),
	HYBRID_WB = (COLOR_TEST_WHITE | COLOR_TEST_BLACK),
	HYBRID_UB = (COLOR_TEST_BLUE | COLOR_TEST_BLACK),
	HYBRID_UR = (COLOR_TEST_BLUE | COLOR_TEST_RED),
	HYBRID_BR = (COLOR_TEST_BLACK | COLOR_TEST_RED),
	HYBRID_BG = (COLOR_TEST_BLACK | COLOR_TEST_GREEN),
	HYBRID_RG = (COLOR_TEST_RED | COLOR_TEST_GREEN),
	HYBRID_RW = (COLOR_TEST_RED | COLOR_TEST_WHITE),
	HYBRID_GW = (COLOR_TEST_GREEN | COLOR_TEST_WHITE),
	HYBRID_GU = (COLOR_TEST_GREEN | COLOR_TEST_BLUE),
	...
	// others
	HYBRID_COLORLESS = COLOR_TEST_COLORLESS,
	HYBRID_C = HYBRID_COLORLESS,
} hybrid_t;
...
typedef enum
{										  // results from EVENT_GRAVEYARD_ABILITY or EVENT_CAN_ACTIVATE_FROM_HAND
...
typedef enum
{									 // results from EVENT_PAY_FLASHBACK_COST
...
typedef enum
{
	...
	EF_EA_MASK = (EA_MARTYR | EA_SELECT_ATTACK | EA_SELECT_BLOCK | EA_LICH | EA_PAID_ATTACK | EA_PAID_BLOCK | EA_BEFORE_COMBAT | EA_DECLARE_ATTACK | EA_FELLWAR_STONE | EA_CONTROLLED | EA_FORCE_ATTACK),
