...
typedef enum
{
  FT_0 = 0,
  FT_LAND = 0x1,
  FT_LAND_LAND_AND_MANA = 0x2,
  FT_LAND_LAND_ONLY = 0x4,
  FT_LAND_MANA_ONLY = 0x8,
  FT_ARTIFACT = 0x10,
  FT_ARTIFACT_CREATURE = 0x20,
  FT_ARTIFACT_NON_CREATURE = 0x40,
  FT_CREATURE = 0x80,
  FT_CREATURE_CREATURE = 0x100,
  FT_CREATURE_TOKEN = 0x200,
