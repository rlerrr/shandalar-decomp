...
int put_card_on_stack(int player, int card, int mode)
{
        ...
        if (player != nonactive_player)
        {
          if (g_duel_ai_mode_state == 1)
          {
            ...
            case 0:
              ...
              if (s.tmp_mana != 0)
              {
                unk_00939340 = s.local_18 = internal_rand(s.tmp_mana) + 1;
              }
              else
              {
                unk_00939340 = s.local_18 = internal_rand(has_mana(player, COLOR_ANY, 1) + 1);
              }
              break;

            case 1:
              unk_00939340 = s.local_18 = has_mana(player, COLOR_ANY, 1);
              if (life[0] < unk_00939340 && internal_rand(3) == 0)
              {
                unk_00939340 = s.local_18 = life[0];
              }
              if (max_x_value != -1 && max_x_value < unk_00939340)
              {
                unk_00939340 = s.local_18 = max_x_value;
              }
              break;
            }
  ...
  if (s.internal_card_id != -1)
  {
    ...
    if (player == active_player && (g_duel_network_flags & 2) == 0 && g_duel_ai_mode_state == 1 && s.card_data->cc[1] == -1)
    {
...
int damage_creature(int target_player, int target_card, int amount, int source_player, int source_card)
{
  ...
  if (result != -1)
  {
    ...
    else
    {
      ...
      {
        display_pic_num = get_card_display_pic_num(global_cards_data[source_internal_card_id].id, source_player, source_card);
        *(unsigned int *)&PLAYER_CARD_INSTANCE(damage_player, result).display_pic_csv_id =
...
int charge_mana(int player, color_t color, int amount)
{
...

  {
    ...
    if (unk_00715fb0 != 0 || (active_player == player && (g_duel_network_flags & 2) == 0) || g_duel_ai_mode_state == 1 || g_duel_network_state != 0)
    {
        ...
        if (unk_00742fcc == -1 && (s.selected_card == -1 || s.selected_card == -2))
        {
          ...
          else if (g_target_selection_status_code == -3 && player == DAT_00715fa4 && DAT_0072c8e0 != -1)
          {
            ...
            if (raw_mana_available[player][DAT_0072c8e0] > 0)
            {
              ...
              {
                s.produced_color = (unsigned short)unk_007161e0[player][s.slot];
                s.special_color = ((unsigned int)unk_007161e0[player][s.slot] >> 16) & 0xffff;
...
void FUN_00446c95(int player, int card, int unk1, int unk2)
{
  (void)player;
  (void)card;
  (void)unk1;
...
void FUN_004a61a1(int player, int card, int unk1, int unk2)
{
  ...
  FUN_00446c95(player, card, unk1, unk2);
}
